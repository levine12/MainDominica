...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/dominicamodule/dominicamoduleLink.form'.
 */
@Controller
@RequestMapping(value = "module/dominicamodule/dominicamoduleLink.form")
public class DominicaModuleFormController{
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/dominicamodule/pharmFindPatientLink";

...
import org.openmrs.module.dominicamodule.DrugInteraction;
...
@Controller
@RequestMapping(value = "/module/dominicamodule/processPrescription.form")
public class PharmDispenseController{
 ...
 public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return new ModelAndView("module/dominicamodule/pharmDispenseReturnPrescriptions", map);
    }

...
public class PatientDrugsController {
     ...
     */
    @RequestMapping("/module/dominicamodule/notes")
     ...
     */
    @RequestMapping(value = "/module/dominicamodule/addNote", method = RequestMethod.POST)
    public String addNote(@RequestParam("patient_id") Patient patient,
        ...
        // this goes to /openmrs/module/dominicamodule/notes.form typically
